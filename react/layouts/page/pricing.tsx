          ...
          <div className="col-12 col-md-4 col-lg-4">
            <div className="pricing">
              ...
              <div className="pricing-cta">
                <a href="javascript:void(0)">Subscribe <i className="fas fa-arrow-right"></i></a>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-4 col-lg-4">
              ...
              <div className="pricing-padding">
                ...
                <div className="pricing-details">
                  <div className="pricing-item">
                    ...
                    <div className="pricing-item-label">Unlimited user agent</div>
                  </div>
                  <div className="pricing-item">
                    <div className="pricing-item-icon">
                      <i className="fas fa-check"></i>
                  ...
                  <div className="pricing-item">
                    ...
                    <div className="pricing-item-label">Unlimited custom domain</div>
                  </div>
                  <div className="pricing-item">
                    <div className="pricing-item-icon">
                      <i className="fas fa-check"></i>
