  ...
  return (
    <section className="section">
      ...
      <div className="section-body">
          ...
          <div className="col-12 col-md-6 col-lg-6">
            <div className="card card-secondary">
              <div className="card-header">
                ...
                <div className="card-header-action">
                  <a href="#" className="btn btn-primary">View All</a>
                  <a href="#" className="btn btn-danger">Delete All</a>
                </div>
              </div>
              <div className="card-body">
                <p>Write something here</p>
                ...
                <div className="card-header-action">
                  ...
                  <div className="dropdown">
                    ...
                    <div className="dropdown-menu">
                      ...
                      ><i className="fas fa-eye"></i> View</a
                      >
                      <a href="#" className="dropdown-item has-icon"
        ...
        <p className="section-lead">You can provide functionality on the card.</p>
          ...
          <div className="col-12 col-sm-6 col-lg-6">
            <div className="card">
              ...
              <div className="collapse show" id="mycard-collapse">
                <div className="card-body">You can show or hide this card.</div>
            ...
            <div className="card" id="sample-login">
              <form>
                ...
                <div className="card-footer pt-">
                  ...
                  <a href="#" className="ml-2">Create new Account?</a>
                </div>
              </form>
            </div>
          </div>
        ...
        <p className="section-lead">Other cool cards, this one can be sorted.</p>
