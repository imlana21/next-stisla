...
export default function AdvancedFormComponent() {
  return (
    <div>
      ...
      <div className="section-body">
        ...
        <p className="section-lead">
          We provide advanced input fields, such as date picker, color picker, and
          so on.
        </p>
